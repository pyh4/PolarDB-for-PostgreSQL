				  ...
				  char *completionTag)
{
	...
	PlannedStmt *plan;
	QueryDesc  *queryDesc;
	/* TODO(pengyonghui): Should we allow 'CREATE TABLE AS' to parallelize, too? */
	int cursorOptions = px_enable_matviewbuild ? CURSOR_OPT_PARALLEL_OK | CURSOR_OPT_PX_OK : CURSOR_OPT_PARALLEL_OK;
